...
float p_kp=5,p_ki=0,p_kd = 0.0;
float s_kp=2.50,s_ki=0.06,s_kd=1.50;
...
//    unit_param_set(&weight11,TYPE_INT,1    ,2  ,0,NORMAL_PAR,"weight11");
	  unit_param_set(&p_kp,TYPE_FLOAT,1	   ,3  ,3,NORMAL_PAR,"p_kp");
    unit_param_set(&p_ki,TYPE_FLOAT,0.01    ,3  ,3,NORMAL_PAR,"p_ki");	
    unit_param_set(&p_kd,TYPE_FLOAT,0.01    ,3  ,3,NORMAL_PAR,"p_kd");	
    ...
    unit_param_set(&speed_base,TYPE_INT,100    ,4  ,1,NORMAL_PAR,"spe");	
