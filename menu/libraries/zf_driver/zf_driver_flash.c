...
// 使用示例     flash_check(127, 3);
// 备注信息     
//-------------------------------------------------------------------------------------------------------------------
uint8 flash_check (uint32 sector_num, uint32 page_num)
{
    zf_assert(FLASH_MAX_SECTION_INDEX > sector_num);                            // 参数范围 0-127
...
// 返回参数     void
// 使用示例     flash_read_page(127, 3, data_buffer, 256);
// 备注信息     
//-------------------------------------------------------------------------------------------------------------------
...
// 参数说明     len             需要写入的数据长度   参数范围 1-256
// 返回参数     uint8           1-表示失败 0-表示成功
// 使用示例     flash_write_page(127, 3, data_buffer, 256);
// 备注信息     
//-------------------------------------------------------------------------------------------------------------------
...
// 参数说明     page_num        当前扇区页的编号   参数范围 <0 - 3>
// 返回参数     void
// 使用示例     flash_read_page_to_buffer(127, 3);
// 备注信息     
//-------------------------------------------------------------------------------------------------------------------
...
// 参数说明     page_num        当前扇区页的编号   参数范围 <0 - 3>
// 返回参数     uint8           1-表示失败 0-表示成功
// 使用示例     flash_write_page_from_buffer(127, 3);
// 备注信息     
//-------------------------------------------------------------------------------------------------------------------
