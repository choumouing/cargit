...
void exti_init (gpio_pin_enum pin, exti_trigger_enum trigger)
{
    ...
    {
        case 0:     interrupt_enable(EXTI0_IRQn);       break;                  // 使能 Line0 的中断响应
        case 1:     interrupt_enable(EXTI1_IRQn);       break;                  // 使能 Line1 的中断响应
        case 2:     interrupt_enable(EXTI2_IRQn);       break;                  // 使能 Line2 的中断响应
        case 3:     interrupt_enable(EXTI3_IRQn);       break;                  // 使能 Line3 的中断响应
        case 4:     interrupt_enable(EXTI4_IRQn);       break;                  // 使能 Line4 的中断响应
        case 5:
        case 6:
        case 7:
        case 8:
        case 9:     interrupt_enable(EXTI9_5_IRQn);     break;                  // 使能 Line5-9 的中断响应
        case 10:
        case 11:
        case 12:
        case 13:
        case 14:
        case 15:    interrupt_enable(EXTI15_10_IRQn);   break;                  // 使能 Line10-15 的中断响应
        default:                                        break;
    }
}
