...
{
    zf_assert((sck_pin & (spi_n << 12)) == (spi_n << 12));                                      // sck_pin  与 spi_n 匹配
    zf_assert((mosi_pin & (spi_n << 12)) == (spi_n << 12));                                     // mosi_pin 与 spi_n 匹配
    zf_assert(((miso_pin & (spi_n << 12)) == (spi_n << 12)) || (SPI_MISO_NULL == miso_pin));    // miso_pin 与 spi_n 匹配
    zf_assert(((cs_pin & (spi_n << 12)) == (spi_n << 12)) || (SPI_CS_NULL == cs_pin));          // cs_pin   与 spi_n 匹配
