...
void pwm_set_duty (pwm_channel_enum pin, const uint32 duty)
{
    ...
    {
        case 0x01000:   tim_index->CCR[0] = match_temp; break;                  // 装载比较值
        case 0x02000:   tim_index->CCR[1] = match_temp; break;                  // 装载比较值
        case 0x03000:   tim_index->CCR[2] = match_temp; break;                  // 装载比较值
        case 0x04000:   tim_index->CCR[3] = match_temp; break;                  // 装载比较值
