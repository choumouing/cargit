...
void timer_clock_enable (timer_index_enum index)
{
    switch(index)
    {
        case TIM_1: RCC->APB2ENR |= 0x00000001;         break;                  // 使能时钟
        case TIM_2: RCC->APB1ENR |= 0x00000001;         break;                  // 使能时钟
        case TIM_3: RCC->APB1ENR |= 0x00000001 << 1;    break;                  // 使能时钟
        case TIM_4: RCC->APB1ENR |= 0x00000001 << 2;    break;                  // 使能时钟
        case TIM_5: RCC->APB1ENR |= 0x00000001 << 3;    break;                  // 使能时钟
        case TIM_6: RCC->APB1ENR |= 0x00000001 << 4;    break;                  // 使能时钟
        case TIM_7: RCC->APB1ENR |= 0x00000001 << 5;    break;                  // 使能时钟
        case TIM_8: RCC->APB2ENR |= 0x00000001 << 1;    break;                  // 使能时钟
        default:                                        break;
    }
}
