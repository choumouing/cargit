...
int16 encoder_get_count (encoder_index_enum encoder_n)
{
    ...
    switch(encoder_n)
    {
        case TIM1_ENCODER:  result = (int16)TIM1->CNT;  break;
        case TIM2_ENCODER:  result = (int16)TIM2->CNT;  break;
        case TIM3_ENCODER:  result = (int16)TIM3->CNT;  break;
        case TIM4_ENCODER:  result = (int16)TIM4->CNT;  break;
        case TIM5_ENCODER:  result = (int16)TIM5->CNT;  break;
        case TIM8_ENCODER:  result = (int16)TIM8->CNT;  break;
...
void encoder_clear_count (encoder_index_enum encoder_n)
{
    switch(encoder_n)
    {
        case TIM1_ENCODER:  TIM1->EGR |= 0x01;    break;                        // 复位计数值
        case TIM2_ENCODER:  TIM2->EGR |= 0x01;    break;                        // 复位计数值
        case TIM3_ENCODER:  TIM3->EGR |= 0x01;    break;                        // 复位计数值
        case TIM4_ENCODER:  TIM4->EGR |= 0x01;    break;                        // 复位计数值
        case TIM5_ENCODER:  TIM5->EGR |= 0x01;    break;                        // 复位计数值
        case TIM8_ENCODER:  TIM8->EGR |= 0x01;    break;                        // 复位计数值
        default: break;
    }
}
...
void encoder_quad_init (encoder_index_enum encoder_n, encoder_channel1_enum ch1_pin, encoder_channel2_enum ch2_pin)
{
    ...
    switch(encoder_n)
    {
        case TIM1_ENCODER:  tim_index = ((TIM1_Type *)TIM1_BASE);   break;
        case TIM2_ENCODER:  tim_index = ((TIM1_Type *)TIM2_BASE);   break;
        case TIM3_ENCODER:  tim_index = ((TIM1_Type *)TIM3_BASE);   break;
        case TIM4_ENCODER:  tim_index = ((TIM1_Type *)TIM4_BASE);   break;
        case TIM5_ENCODER:  tim_index = ((TIM1_Type *)TIM5_BASE);   break;
        case TIM8_ENCODER:  tim_index = ((TIM1_Type *)TIM8_BASE);   break;
