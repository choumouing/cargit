...
void UNIT_SET(){
	//菜单单元调参参数初始化
    unit_param_set(&Speed,TYPE_INT , 5, 2 ,3,NORMAL_PAR,"Speed");
    unit_param_set(&Kp,TYPE_FLOAT , 0.1 , 1 , 2 ,NORMAL_PAR,"Kp");
    unit_param_set(&Ki,TYPE_FLOAT, 0.1 , 1 , 2 ,NORMAL_PAR,"Ki");
    unit_param_set(&Kd,TYPE_FLOAT, 0.1 , 1  , 2 ,NORMAL_PAR,"Kd");
    unit_param_set(&test_1,TYPE_UINT16, 1 , 3 , 3 ,NORMAL_PAR,"test_1");
}
